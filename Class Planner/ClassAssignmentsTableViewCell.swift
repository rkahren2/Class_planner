...
class ClassAssignmentsTableViewCell: UITableViewCell {

    @IBOutlet weak var classAssignmentNameLabel: UILabel!           //display name of assignment
    @IBOutlet weak var classAssignmentDueDateLabel: UILabel!        //display due date
