...
class CreateAssignmentAllViewController: UIViewController, NSFetchedResultsControllerDelegate,UIPickerViewDataSource,UIPickerViewDelegate {

    @IBOutlet weak var classPickerView: UIPickerView!               //picker for class
    @IBOutlet weak var assignmentNameTextField: UITextField!        //enter assignment name
    @IBOutlet weak var dueDatePicker: UIDatePicker!                 //picker for due date
    @IBOutlet weak var detailsTextView: UITextView!                 //enter assignment details
    
    var courses:[Course] = []                                       //list of classes
    ...
    ************************************************************************************/
    @IBAction func cancelButton(sender: AnyObject) {
        ...
        saveAlert.addAction(UIAlertAction(title: "Continue", style: .Default, handler: {
            (action: UIAlertAction!) in
            self.performSegueWithIdentifier("unwindToAllAssignment", sender: self)        }))
    ...
    ************************************************************************************/
    func saveAssignment(){
        ...
        if errorField != "" {
            ...
            let alertController = UIAlertController(title: "Error Occurs", message: "Missing entry for " + errorField + ". Please give your assignment a name", preferredStyle: .Alert)
        ...
        assignment.details = detailsTextView.text
        //save assignment
        var e: NSError?
