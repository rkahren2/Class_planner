...
class AllNotesTableViewController: UITableViewController, NSFetchedResultsControllerDelegate {
    ...
    @IBOutlet weak var noAllNotesLabel: UILabel!            //no notes message
    //array for notes
    var notes:[Note] = []
    ...
    ************************************************************************************/
    override func tableView(tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        if notes.count == 0{
            ...
            noAllNotesLabel.hidden = false
            tableView.backgroundView = noAllNotesLabel
            tableView.separatorStyle = UITableViewCellSeparatorStyle.None
            return 0
        //otherwise hide no note message and return the number of notes
        }else{
            noAllNotesLabel.hidden = true
    ...
    ************************************************************************************/
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCellWithIdentifier("AllNotesCell", forIndexPath: indexPath) as! AllNotesTableViewCell
        
        // Configure the cell
        let note = notes[indexPath.row]
        cell.noteTitleLabel.text = note.noteTitle
        cell.courseTitleLabel.text = note.courseName
    ...
    ************************************************************************************/
    @IBAction func unwindToAllNotes(segue:UIStoryboardSegue) {
    }
}
